                    ...
                    <div class="card-body">
                        <form id="reviewForm">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="name" placeholder="Ecrivez votre pseudo ici" required>
                            </div>
                            <div class="mb-3">
                                <label for="comment" class="form-label form-label-bg fs-5" >Avis</label>
                                <textarea class="form-control" id="comment" rows="3" placeholder="Ecrivez votre texte ici" required></textarea>
                            </div>
                            <button type="submit" class="btn btn-dark fs-5">Soumettre</button>
                        </form>
                    </div>
                </div>    
            </div>
